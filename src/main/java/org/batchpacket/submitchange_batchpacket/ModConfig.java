...
public class ModConfig {
    ...
    private static AutoBreakMode parseAutoBreakMode(String value) {
        ...
        return switch (normalized = value.trim().toUpperCase(Locale.ROOT)) {
            case "BEDROCK_ONLY", "GENERIC_BLOCK", "CLICK_WHITELIST", "CLICK" -> AutoBreakMode.CLICK;
            case "AREA_BEDROCK", "AREA_WHITELIST", "AREA" -> AutoBreakMode.AREA;
            case "AREA_CHUNK" -> AutoBreakMode.AREA_CHUNK;
    ...
    public void setAutoBreakBedrock(boolean enabled) {
        this.autoBreakMode = enabled ? AutoBreakMode.CLICK : AutoBreakMode.OFF;
        this.saveIfAllowed();
    }
